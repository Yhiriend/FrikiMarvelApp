...
import { CharactersList } from '../../../domain/entities/character.entity';
...
export class SearchCharactersUseCase {
  ...
  async execute(query: string, offset: number = 0, limit: number = 20): Promise<CharactersList> {
    ...
    return await this.characterRepository.searchCharacters(query.trim(), offset, limit);
  }
}
